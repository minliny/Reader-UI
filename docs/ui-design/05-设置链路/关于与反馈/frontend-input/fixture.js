window.ABOUT_FEEDBACK_FIXTURE = {
  ...
  sections: [
    ...
    },
    {
      title: "反馈与支持",
      rows: [
        { type: "link", icon: "bug", title: "问题反馈", meta: "提交复现步骤、截图和日志片段" },
        { type: "link", icon: "message", title: "功能建议", meta: "记录阅读、书架、书源等改进想法" },
  ...
  actions: [
    { icon: "log", title: "导出诊断日志", meta: "导出运行日志、设备信息和最近错误，不包含书籍正文" }
  ],
  toast: {
    success: "已是最新版本",
    error: "加载失败，请重试",
  ...
  states: [
    { key: "default", toast: "success", title: "关于反馈默认态", desc: "版本、更新、反馈、源码和开源许可可见。" },
  ...
  stateSummary: "用于核对版本、检查更新、反馈入口、源码仓库、开源许可、诊断导出和离线状态。"
};
