...
const renderLoader = readFrontend("render.js");
const runtime = readFrontend("render-runtime.js");
const controller = readFrontend("motion-controller.js");
const motionTokens = readFrontend("motion-tokens.css");
const routeContractSource = readFrontend("route-contract.js");
const routeSchema = JSON.parse(readRepo("contracts/route.schema.json"));
const motionSchema = JSON.parse(readRepo("contracts/motion.schema.json"));
const motionFixtures = JSON.parse(readRepo("contracts/fixtures/motion.fixtures.json"));
...
const sourceText = sourceFiles.map(readFrontend).join("\n");
